# How Things Work - Practice Exam 1 Solutions
### Avi Herman
...
If the period doubles, the angular velocity \(\omega\) is halved. Since kinetic energy depends on \(\omega^2\), halving \(\omega\) reduces the energy by a factor of:
